                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        @if($topic->images != null)
                                            <tr>
                                                ...
                                                <td>
                                                    <img class="fix_size_image" src="{{ url(config('common.uploads') . $topic->images) }}"/>
                                                </td>
                                            </tr>
                                        @endif
                                    </table>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($topic->status == 1)
                                                    <label
                                                            class="btn btn-xs btn-circle green-jungle">{{ trans('message.active') }}</label>
                                                @else
                                                    <label
                                                            class="btn btn-xs btn-circle grey-mint">{{ trans('message.deactivate') }}</label>
                                                @endif
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                @if ($topic->set_time == 1)
                                                    <label
                                                            class="btn btn-xs btn-circle blue-madison">{{ trans('message.timer') }}</label>
                                                @else
                                                    <label
                                                            class="btn btn-xs btn-circle grey-salt">{{ trans('message.no_timer') }}</label>
                                                @endif
                                            </td>
                                        </tr>
                                    </table>
