                            ...
                            @foreach($topics as $topic)
                                <tr>
                                    ...
                                    <td>
                                        @if ($topic->status == 1)
                                            <label
                                                    class="btn btn-xs btn-circle green-jungle ladda-label">{{ trans('message.active') }}</label>
                                        @else
                                            <label
                                    ...
                                    <td>
                                        @if ($topic->set_time == 1)
                                            <label
                                                    class="btn btn-xs btn-circle green-sharp">{{ trans('message.timer') }}</label>
                                        @else
                                            <label
                                                    class="btn btn-xs btn-circle yellow-soft">{{ trans('message.no_timer') }}</label>
                                        @endif
                                    </td>
                                    <td>
